namespace Examination_PRL.Forms.Staff.Home
{
    partial class Home
    {
        ...
        private void InitializeComponent()
        {
            ...
            ((System.ComponentModel.ISupportInitialize)panelTotalExam).BeginInit();
            panelTotalExam.SuspendLayout();
            ((System.ComponentModel.ISupportInitialize)panelWelcome).BeginInit();
            ...
            // propertyGrid1
            // 
            propertyGrid1.AllowDefaultContextMenu = false;
            propertyGrid1.Dock = DockStyle.Fill;
            propertyGrid1.Location = new Point(2, 22);
            propertyGrid1.Margin = new Padding(3, 4, 3, 4);
            propertyGrid1.Name = "propertyGrid1";
            propertyGrid1.Size = new Size(200, 300);
            ...
            panelWelcome.BackColor = Color.Lavender;
            panelWelcome.Controls.Add(lnlFullName);
            panelWelcome.Location = new Point(12, 12);
            panelWelcome.Name = "panelWelcome";
            // 
            // 
            // 
            panelWelcome.RootElement.BorderHighlightThickness = 0;
            panelWelcome.RootElement.ShadowColor = Color.FromArgb(170, 255, 255, 255);
            panelWelcome.Size = new Size(1731, 43);
            panelWelcome.TabIndex = 6;
            panelWelcome.ThemeName = "MaterialTeal";
            ((Telerik.WinControls.UI.RadPanelElement)panelWelcome.GetChildAt(0)).Text = "";
            ((Telerik.WinControls.UI.RadPanelElement)panelWelcome.GetChildAt(0)).ShadowColor = Color.FromArgb(170, 255, 255, 255);
            ((Telerik.WinControls.Primitives.BorderPrimitive)panelWelcome.GetChildAt(0).GetChildAt(1)).BoxStyle = Telerik.WinControls.BorderBoxStyle.FourBorders;
            ((Telerik.WinControls.Primitives.BorderPrimitive)panelWelcome.GetChildAt(0).GetChildAt(1)).SmoothingMode = System.Drawing.Drawing2D.SmoothingMode.None;
            ((Telerik.WinControls.Primitives.BorderPrimitive)panelWelcome.GetChildAt(0).GetChildAt(1)).Visibility = Telerik.WinControls.ElementVisibility.Collapsed;
            // 
            // panelBlock1
            // 
            ...
            ((Telerik.WinControls.UI.RadPanelElement)panelBlock1.GetChildAt(0)).ShadowDepth = 0;
            ((Telerik.WinControls.UI.RadPanelElement)panelBlock1.GetChildAt(0)).ShadowColor = Color.FromArgb(170, 255, 255, 255);
            ((Telerik.WinControls.UI.RadPanelElement)panelBlock1.GetChildAt(0)).BorderHighlightThickness = 0;
            ((Telerik.WinControls.UI.RadPanelElement)panelBlock1.GetChildAt(0)).ShouldPaint = false;
            ((Telerik.WinControls.UI.RadPanelElement)panelBlock1.GetChildAt(0)).ClipDrawing = false;
            ((Telerik.WinControls.Primitives.BorderPrimitive)panelBlock1.GetChildAt(0).GetChildAt(1)).BoxStyle = Telerik.WinControls.BorderBoxStyle.OuterInnerBorders;
            ...
            ((Telerik.WinControls.UI.RadPanelElement)panelBlock2.GetChildAt(0)).ShadowColor = Color.FromArgb(170, 255, 255, 255);
            ((Telerik.WinControls.Primitives.BorderPrimitive)panelBlock2.GetChildAt(0).GetChildAt(1)).BoxStyle = Telerik.WinControls.BorderBoxStyle.FourBorders;
            ...
            ((Telerik.WinControls.Primitives.BorderPrimitive)panelScheduleIncoming.GetChildAt(0).GetChildAt(1)).BoxStyle = Telerik.WinControls.BorderBoxStyle.FourBorders;
            ((Telerik.WinControls.Primitives.BorderPrimitive)panelScheduleIncoming.GetChildAt(0).GetChildAt(1)).SmoothingMode = System.Drawing.Drawing2D.SmoothingMode.None;
            ((Telerik.WinControls.Primitives.BorderPrimitive)panelScheduleIncoming.GetChildAt(0).GetChildAt(1)).Visibility = Telerik.WinControls.ElementVisibility.Collapsed;
            // 
            // label4
            // 
            ...
            ((Telerik.WinControls.Primitives.BorderPrimitive)panelScheduleCurrent.GetChildAt(0).GetChildAt(1)).BoxStyle = Telerik.WinControls.BorderBoxStyle.FourBorders;
            ((Telerik.WinControls.Primitives.BorderPrimitive)panelScheduleCurrent.GetChildAt(0).GetChildAt(1)).SmoothingMode = System.Drawing.Drawing2D.SmoothingMode.None;
            ((Telerik.WinControls.Primitives.BorderPrimitive)panelScheduleCurrent.GetChildAt(0).GetChildAt(1)).Visibility = Telerik.WinControls.ElementVisibility.Collapsed;
            // 
            // label6
            // 
            ...
            ((Telerik.WinControls.UI.RadPanelElement)panelBlock3.GetChildAt(0)).ShadowColor = Color.FromArgb(170, 255, 255, 255);
            ((Telerik.WinControls.Primitives.BorderPrimitive)panelBlock3.GetChildAt(0).GetChildAt(1)).BoxStyle = Telerik.WinControls.BorderBoxStyle.FourBorders;
            ...
            ClientSize = new Size(1755, 760);
            Controls.Add(panelBlock3);
            Controls.Add(panelBlock2);
            Controls.Add(panelWelcome);
            Controls.Add(panelBlock1);
            ...
            ((System.ComponentModel.ISupportInitialize)propertyGrid1).EndInit();
            ((System.ComponentModel.ISupportInitialize)panelTotalRoom).EndInit();
            panelTotalRoom.ResumeLayout(false);
            panelTotalRoom.PerformLayout();
            ((System.ComponentModel.ISupportInitialize)panelTotalExam).EndInit();
            panelTotalExam.ResumeLayout(false);
            panelTotalExam.PerformLayout();
            ((System.ComponentModel.ISupportInitialize)panelWelcome).EndInit();
            ...
            ((System.ComponentModel.ISupportInitialize)panelScheduleCurrent).EndInit();
            panelScheduleCurrent.ResumeLayout(false);
        ...
        private Telerik.WinControls.UI.RadPanel panelBlock1;
        private Telerik.WinControls.UI.RadPropertyGrid propertyGrid1;
        private Telerik.WinControls.UI.RadPanel panelTotalRoom;
        ...
        private Telerik.WinControls.UI.RadPanel panelScheduleCurrent;
